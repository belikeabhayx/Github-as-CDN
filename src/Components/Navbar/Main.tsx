...
import { handleSignOut, signOut } from "@/app/auth";
            ...
            <div className="flex flex-col items-center justify-between border-b-2 border-gray-100 py-6 md:flex-row md:justify-start md:space-x-10">
              ...
              <div className="flex items-center">
                <Link
                  ...
                  target="_blank"
                  className="mr-4 text-base font-medium text-gray-700 hover:text-gray-900"
                >
                  <BsGithub />
                </Link>
                <Link
                  ...
                  target="_blank"
                  className="mr-4 text-base text-gray-700 hover:text-gray-900"
                >
                  <BsTwitterX />
                </Link>
                      ...
                      <>
                        ...
                        >
                          <span className="mr-2 text-indigo-600 underline underline-offset-8">
                            {session.user?.name} / <RepoConnector />
                          </span>
                          <img
                            //@ts-ignore
        ...
        <div className="flex items-center justify-center border-t border-gray-300 py-8 text-center text-sm">
          ...
          >
            <svg
              viewBox="0 0 20 20"
              aria-hidden="true"
              className="ml-2 size-5 cursor-pointer fill-slate-400 hover:fill-indigo-500"
            >
